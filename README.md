...
## Instructions
  ...
  4. Write a method that takes an `NSArray` of `NSDictionary` representations of Locations and returns a list of just the names of the locations sorted alphabetically
